...
/**
 * Value Object para comunicação REST da entidade Inscricao
...
public class InscricaoVO implements Serializable {
	...
	private String tamanhoCamisetaDescricao;
	...
	public String getTamanhoCamisetaDescricao() {
		return tamanhoCamisetaDescricao;
	}

	public void setTamanhoCamisetaDescricao(String tamanhoCamisetaDescricao) {
		this.tamanhoCamisetaDescricao = tamanhoCamisetaDescricao;
	}
